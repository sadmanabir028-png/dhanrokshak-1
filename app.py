...
def main():
    ...
    <div class="header-bg">
        ...
        <h3 class="bengali-font">কৃত্রিম বুদ্ধিমত্তা চালিত ধান রোগ শনাক্তকরণ </h3>
    ...
    <div style="text-align: center; color: #666;">
        <p class="bengali-font">© ২০২৫ ধানরক্ষক - কৃষকের জন্য AI সমাধান</p>
        <p class="bengali-font">বাংলাদেশের কৃষকদের জন্য নিবেদিত</p>
    </div>
    """, unsafe_allow_html=True)
